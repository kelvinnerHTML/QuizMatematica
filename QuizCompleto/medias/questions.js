var questions = [
      //1
      ["(Enem 2018) A Comissão Interna de Prevenção de Acidentes (CIPA) de uma empresa, observando os altos custos com os frequentes acidentes de trabalho ocorridos, fez, a pedido da diretoria, uma pesquisa do número de acidentes sofridos por funcionários. Essa pesquisa, realizada com uma amostra de 100 funcionários, norteará as ações da empresa na política de segurança no trabalho. Os resultados obtidos estão no quadro. A média do número de acidentes por funcionário na amostra que a CIPA apresentará à diretoria da empresa é",
      "0,15","0,30","0,30","1,11","2,22",
      "img/ex1.PNG"  , "", "","", "","",
      "4"],
       //2
      ["(Enem 2017)  Três alunos,   e   estão matriculados em um curso de inglês. Para avaliar esses alunos, o professor optou por fazer cinco provas. Para que seja aprovado nesse curso, o aluno deverá ter a média aritmética das notas das cinco provas maior ou igual a   Na tabela, estão dispostas as notas que cada aluno tirou em cada prova. Com base nos dados da tabela e nas informações dadas, ficará(ão) reprovado(s) ",
      " apenas o aluno Y","apenas o aluno Z"," apenas o alunos X e Y"," apenas o alunos X e Z"," os alunos X, Y e Z",
      "img/ex2.PNG"  , "", "","", "","",
      "2"],
      //3    
      ["(Enem 2017)  A avaliação de rendimento de alunos de um curso universitário baseia-se na média ponderada das notas obtidas nas disciplinas pelos respectivos números de créditos, como mostra o quadro. Quanto melhor a avaliação de um aluno em determinado período letivo, maior sua prioridade na escolha de disciplinas para o período seguinte. Determinado aluno sabe que se obtiver avaliação “Bom” ou “Excelente” conseguirá matrícula nas disciplinas que deseja. Ele já realizou as provas de   das   disciplinas em que está matriculado, mas ainda não realizou a prova da disciplina I, conforme o quadro.  Para que atinja seu objetivo, a nota mínima que ele deve conseguir na disciplina I é",
      " 7,00","7,38"," 7,50"," 8,25"," 9,00",
      "img/ex3.PNG"  , "", "","", "","",
      "4"],
      //4
      ["(Enem 2016)  Preocupada com seus resultados, uma empresa fez um balanço dos lucros obtidos nos últimos sete meses, conforme dados do quadro. Avaliando os resultados, o conselho diretor da empresa decidiu comprar, nos dois meses subsequentes, a mesma quantidade de matéria-prima comprada no mês em que o lucro mais se aproximou da média dos lucros mensais dessa empresa nesse período de sete meses. Nos próximos dois meses, essa empresa deverá comprar a mesma quantidade de matéria-prima comprada no mês",
      " I"," II"," IV"," V"," VII",
      "img/ex4.PNG"  , "", "","", "","",
      "4"],

      //5
      ["(Enem 2016)  Em uma cidade, o número de casos de dengue confirmados aumentou consideravelmente nos últimos dias. A prefeitura resolveu desenvolver uma ação contratando funcionários para ajudar no combate à doença, os quais orientarão os moradores a eliminarem criadouros do mosquito Aedes aegypti, transmissor da dengue. A tabela apresenta o número atual de casos confirmados, por região da cidade. A prefeitura optou pela seguinte distribuição dos funcionários a serem contratados: I.   funcionários para cada região da cidade cujo número de casos seja maior que a média dos casos confirmados. II.   funcionários para cada região da cidade cujo número de casos seja menor ou igual à média dos casos confirmados. Quantos funcionários a prefeitura deverá contratar para efetivar a ação?",
      " 59"," 65"," 68","71"," 80",
      "img/ex5.PNG"  , "", "","", "","",
      "4"],
      //6
      ["(Enem 2016)  A permanência de um gerente em uma empresa está condicionada à sua produção no semestre. Essa produção é avaliada pela média do lucro mensal do semestre. Se a média for, no mínimo, de   mil reais, o gerente permanece no cargo, caso contrário, ele será despedido. O quadro mostra o lucro mensal, em milhares de reais, dessa empresa, de janeiro a maio do ano em curso. Qual deve ser o lucro mínimo da empresa no mês de junho, em milhares de reais, para o gerente continuar no cargo no próximo semestre? ",
      " 26"," 29"," 30"," 31"," 35",
      "img/ex6.PNG"  , "", "","", "","",
      "5"],
     //7
      ["(Enem 2016)  Um posto de saúde registrou a quantidade de vacinas aplicadas contra febre amarela nos últimos cinco meses: - 1º mês:  - 2º mês:  - 3º mês:  - 4º mês:  - 5º mês:   No início do primeiro mês, esse posto de saúde tinha   vacinas contra febre amarela em estoque. A política de reposição do estoque prevê a aquisição de novas vacinas, no início do sexto mês, de tal forma que a quantidade inicial em estoque para os próximos meses seja igual a   vezes a média das quantidades mensais dessas vacinas aplicadas nos últimos cinco meses. Para atender essas condições, a quantidade de vacinas contra febre amarela que o posto de saúde deve adquirir no início do sexto mês é ",
      "156 ","180 ","192 ","264 ","288 ",
      ""  , "", "","", "","",
      "2"],
      //8
      ["(Enem 2015)  Um concurso é composto por cinco etapas. Cada etapa vale   pontos. A pontuação final de cada candidato e a média de suas notas nas cinco etapas. A classificação obedece à ordem decrescente das pontuações finais. O critério de desempate baseia-se na maior pontuação na quinta etapa. A ordem de classificação final desse concurso é ",
      "A,B,C,E,D","B,A,C,E,D ","C,B,E,A,D ","C,B,E,D,A ","E,C,D,B,A",
      "img/ex8.PNG"  , "", "","", "","",
      "2"],
      //9
