var questions = [
    ...
    ["5. (Enem 2011)  A figura seguinte mostra um modelo de sombrinha muito usado em países orientais.",
    "img/5.png",
    ...
    ["6. (Enem 2ª aplicação 2010)  Um arquiteto está fazendo um projeto de iluminação de ambiente e necessita saber a altura que deverá instalar a luminária ilustrada na figura",
    "Sabendo-se que a luminária deverá iluminar uma área circular de 28,26m², considerando pi=3,14 , a altura h será igual a ", 
    "img/6.png",
    "a)3", "b)4", "c)5", "d)9", "e)10",
    "2"
    ],
    ["7.Para substituir as taças quebradas, utilizou-se um outro tipo com formato de cone (Figura 2). No entanto, os noivos solicitaram que o volume de champanhe nos dois tipos de taças fosse igual.",
    "Considere:",
    ...
    ["9. (Enem 1999)  Assim como na relação entre o perfil de um corte de um torno e a peça torneada, sólidos de revolução resultam da rotação de figuras planas em torno de um eixo. Girando-se as figuras a seguir em torno da haste indicada obtém-se os sólidos de revolução que estão na coluna da direita.",
    ...
    ["10. (Epcar (Afa) 2017)  Se uma pirâmide hexagonal regular está inscrita num cone equilátero cujo volume é igual a   então o volume dessa pirâmide, em cm³, é igual a ",
    "a)img/10a.png", "b)img/10b.png", "c)img/10c.png", "d)img/10d.png",
    "1"
    ],
]