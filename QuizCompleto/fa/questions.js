...
var questions = [
    ...
    ["3. (Enem 2016)  Uma cisterna de   foi esvaziada em um período de   Na primeira hora foi utilizada apenas uma bomba, mas nas duas horas seguintes, a fim de reduzir o tempo de esvaziamento, outra bomba foi ligada junto com a primeira. O gráfico, formado por dois segmentos de reta, mostra o volume de água presente na cisterna, em função do tempo.Qual é a vazão, em litro por hora, da bomba que foi ligada no início da segunda hora? ",
        "1000", "1250", "1500", "2000", "2500",
        "img/ex3.png", "", "", "", "", "",
        "3"
    ],

    ["4. (Enem 2016)  Um reservatório é abastecido com água por uma torneira e um ralo faz a drenagem da água desse reservatório. Os gráficos representam as vazões   em litro por minuto, do volume de água que entra no reservatório pela torneira e do volume que sai pelo ralo, em função do tempo   em minuto.Em qual intervalo de tempo, em minuto, o reservatório tem uma vazão constante de enchimento?",
        "De 0 a 10", "De 5 a 10", "De 5 a 15", "De 15 a 25", "De 0 a 25",
        "img/ex4.png", "", "", "", "", "",
        "2"
    ],

    ["5. (Enem 2014) No Brasil, há várias operadoras e planos de telefonia celular.Uma pessoa recebeu 5 propostas(A, B, C, D, E) de planos telefônicos.O valor mensal de cada plano está em função do tempo mensal das chamadas conforme o gráfico.Essa pessoa pretende gastar exatamente R$30,00  por mês com telefone.Dos planos telefônicos apresentados, qual é o mais vantajoso, em tempo de chamada, para o gasto previsto para essa pessoa?",
        "A", "B", "C", "D", "E",
        "img/ex5.png", "", "", "", "", "",
        "3"
    ...
    ["7. (Enem 2011)  O saldo de contratações no mercado formal no setor varejista da região metropolitana de São Paulo registrou alta. Comparando as contratações deste setor no mês de fevereiro com as de janeiro deste ano, houve incremento de 4.300 vagas no setor, totalizando 880.605 trabalhadores com carteira assinada. Suponha que o incremento de trabalhadores no setor varejista seja sempre o mesmo nos seis primeiros meses do ano. Considerando-se que y e x representam, respectivamente, as quantidades de trabalhadores no setor varejista e os meses, janeiro sendo o primeiro, fevereiro, o segundo, e assim por diante, a expressão algébrica que relaciona essas quantidades nesses meses é ",
